...
install("kadira:blaze-layout");                                              // 79
install("erasaur:meteor-lodash");                                            // 80
install("stolinski:stylus-multi");                                           // 81
install("fortawesome:fontawesome");                                          // 82
install("callback-hook");                                                    // 83
install("spiderable");                                                       // 84
install("fastclick");                                                        // 85
install("ui");                                                               // 86
install("session");                                                          // 87
install("raix:handlebar-helpers");                                           // 88
...
install("livedata");                                                         // 95
install("momentjs:moment");                                                  // 96
install("aldeed:autoform");                                                  // 97
...
install("matb33:bootstrap-base");                                            // 108
install("matb33:bootstrap-glyphicons");                                      // 109
install("meteortoys:toykit");                                                // 110
install("msavin:jetsetter");                                                 // 111
install("coffeescript");                                                     // 112
install("iron:core");                                                        // 113
install("iron:dynamic-template");                                            // 114
install("iron:layout");                                                      // 115
install("iron:url");                                                         // 116
install("iron:middleware-stack");                                            // 117
install("iron:location");                                                    // 118
install("iron:controller");                                                  // 119
install("iron:router");                                                      // 120
install("zimme:active-route");                                               // 121
install("gwendall:auth-client-callbacks");                                   // 122
install("msavin:mongol");                                                    // 123
install("meteortoys:blueprint");                                             // 124
install("meteortoys:authenticate");                                          // 125
install("meteortoys:shell");                                                 // 126
install("meteortoys:method");                                                // 127
install("meteortoys:result");                                                // 128
install("meteortoys:autopub");                                               // 129
install("meteortoys:pub");                                                   // 130
install("meteortoys:sub");                                                   // 131
install("meteortoys:email");                                                 // 132
install("meteortoys:listen");                                                // 133
install("meteortoys:throttle");                                              // 134
install("meteortoys:status");                                                // 135
install("meteortoys:hotreload");                                             // 136
install("meteortoys:allthings");                                             // 137
install("stylus");                                                           // 138
install("anti:i18n");                                                        // 139
install("ian:accounts-ui-bootstrap-3");                                      // 140
install("webapp");                                                           // 141
install("hot-code-push");                                                    // 142
install("launch-screen");                                                    // 143
install("autoupdate");                                                       // 144
install("mdg:validation-error");                                             // 145
                                                                             // 146
///////////////////////////////////////////////////////////////////////////////
